              ...
              <div class="jumbotron">
                  <div class="row">
                      <div class="col-md-7 col-lg-7 top-kiri">
                          ...
                          <hr>
                          <h2>Selamat Datang,<b> {{ \Auth::guard('student')->user()->name }}</b>.</h2>
                          <h2>Tingkatkan Kemampuan Anda Disini.</h2>
                          <h5>Silahkan memulai pembelajaran yang sudah disediakan. </h5>
                          <a href="{{ url('/student/kelas') }}" class="btn btn-primary btn-login tombol-mulai">Mulai Belajar</a>
                      </div>
